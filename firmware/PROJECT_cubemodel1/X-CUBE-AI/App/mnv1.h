...
#include "mnv1_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_MNV1_MODEL_NAME          "mnv1"
#define AI_MNV1_ORIGIN_MODEL_NAME   "model_quant_v3"

/******************************************************************************/
#define AI_MNV1_ACTIVATIONS_ALIGNMENT   (4)
#define AI_MNV1_INPUTS_IN_ACTIVATIONS   (4)
#define AI_MNV1_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_MNV1_IN_NUM        (1)

AI_DEPRECATED
#define AI_MNV1_IN \
  ai_mnv1_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_MNV1_IN_SIZE { \
  AI_MNV1_IN_1_SIZE, \
}
#define AI_MNV1_IN_SIZE_BYTES { \
  AI_MNV1_IN_1_SIZE_BYTES, \
}
#define AI_MNV1_IN_1_FORMAT      AI_BUFFER_FORMAT_U8
#define AI_MNV1_IN_1_HEIGHT      (128)
#define AI_MNV1_IN_1_WIDTH       (128)
#define AI_MNV1_IN_1_CHANNEL     (3)
#define AI_MNV1_IN_1_SIZE        (128 * 128 * 3)
#define AI_MNV1_IN_1_SIZE_BYTES  (49152)

/******************************************************************************/
#define AI_MNV1_OUT_NUM       (1)

AI_DEPRECATED
#define AI_MNV1_OUT \
  ai_mnv1_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_MNV1_OUT_SIZE { \
  AI_MNV1_OUT_1_SIZE, \
}
#define AI_MNV1_OUT_SIZE_BYTES { \
  AI_MNV1_OUT_1_SIZE_BYTES, \
}
#define AI_MNV1_OUT_1_FORMAT      AI_BUFFER_FORMAT_U8
#define AI_MNV1_OUT_1_CHANNEL     (26)
#define AI_MNV1_OUT_1_SIZE        (26)
#define AI_MNV1_OUT_1_SIZE_BYTES  (26)

/******************************************************************************/
#define AI_MNV1_N_NODES (56)
 ...
 * @ref ai_mnv1_create. Both the activations memory buffer 
 ...
 * header generated by the code generation tool. See AI_MNV1_*
 * defines into file @ref mnv1.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
